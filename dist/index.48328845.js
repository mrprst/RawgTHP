...
})({"hwQPF":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "e80bb9a248328845";
...
},{}],"8Dyl6":[function(require,module,exports) {
const PageDetail = (argument1)=>{
    const preparePage = ()=>{
        ...
        const displayGame = (gameData)=>{
            ...
            // const similarDOM = document.querySelector(".page-detail .similar");
            headerDOM.remove();
            dropdownDOM.remove();
            heroDOM.innerHTML = `
      <img src="${background_image}">
      <a href="${website}"><button>Check Website</button></a>
      `;
            ...
            articleDOM.querySelector(".article--bottom p.platforms").innerHTML = gamePlatforms(platforms);
            articleDOM.querySelector(".article--bottom p.publishers").innerHTML = nodeDetails(publishers);
            articleDOM.querySelector(".article--bottom p.genres").innerHTML = nodeDetails(genres);
            articleDOM.querySelector(".article--bottom p.tags").innerHTML = nodeDetails(tags);
            buyDOM.querySelector("div.buy-links").innerHTML = storesPlatforms(stores).join("");
            screenshotsDOM.querySelector("div.screenshots-links").innerHTML = `<img src="${background_image}" /><img src="${background_image_additional}" />`;
        };
      ...
      <section class="page-detail">
        <div class="article">
          ...
          <div class="article--bottom">
            <p class="released"><b>Release Date</b><br></p>
            <p class="developers"><b>Developer</b><br></p>
            <p class="platforms"><b>Platforms</b><br></p>
            <p class="publishers"><b>Publisher</b><br></p>
            <p class="genres"><b>Genre</b><br></p>
            <p class="tags"><b>Tags</b><br></p>
          </div>
        </div>
        <div class="buy">
          <h1>BUY</h1>
...
function gamePlatforms(node) {
    arrPlatforms = [];
    node.forEach((e)=>{
        arrPlatforms.push(`&nbsp${e.platform.name}`);
    });
    return arrPlatforms;
}
...
function storesPlatforms(node) {
    arrPlatforms = [];
    node.forEach((e)=>{
        arrPlatforms.push(`<a href="https://${e.store.domain}" target="_blank"><p>${e.store.name}</p></a>`);
    });
    return arrPlatforms;
}

},{}]},["hwQPF","8Dyl6"], "8Dyl6", "parcelRequire191b")

//# sourceMappingURL=index.48328845.js.map
